...
\begin{tikzpicture} 
	...
	\node[anchor = south, font = \footnotesize] at (c1.north){cividis};
	\node[anchor = south, font = \footnotesize] at (b1.north){batlow};
	\node[anchor = south, font = \footnotesize] at (r1.north){gist\_rainbow};
