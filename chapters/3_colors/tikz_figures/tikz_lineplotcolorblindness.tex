\begin{tikzpicture}
	\begin{groupplot}[
		...
		\nextgroupplot[cycle list name = highcontrast] 
		\lineplot
		...
		\nextgroupplot[cycle list name = matplotlib, ylabel = {$y$ axis}] 
		\lineplot
		...
		\nextgroupplot[cycle list name = latexdefault] 
		\lineplot

		\nextgroupplot[cycle list name = latexdeut, xlabel = {$x$ axis}] 
		\lineplot 

		\nextgroupplot[cycle list name = latexmono] 
		\lineplot
