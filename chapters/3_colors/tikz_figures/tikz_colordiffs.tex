...
\node[draw = black, thick, inner sep = 0pt, anchor = north] at (dE c1r1.south){\includegraphics[width = 5cm]{\here/colorbarRGB.png}};
\node[draw = black, thick, inner sep = 0pt, anchor = north] at (dE c2r1.south){\includegraphics[width = 5cm]{\here/colorbarHSV.png}};
\node[draw = black, thick, inner sep = 0pt, anchor = north] at (dE c3r1.south){\includegraphics[width = 5cm]{\here/colorbarLab.png}};
