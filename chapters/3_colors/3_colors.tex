...
A twodimensional plot of this function, using the perceptually uniform \verb|viridis| colormap is shown in \figref{fig:sensitivityfunction}. Note how the plot correctly resolves the oscillations even in the limit of strong damping at the upper edge, where $y=1$.
