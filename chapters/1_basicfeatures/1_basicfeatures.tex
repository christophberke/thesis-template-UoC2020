...
However, I wanted all parts to have an individual entry in the table of content of the pdf file (pdf-toc), i.e., the content that is displayed in the content pane / left column of most pdf readers, see \figref{fig:pdf-toc}.
