...
\begin{minipage}[t]{0.55\textwidth}
	\centering 
	\includegraphics[]{somefigure.png} % or input tikz-file.
\end{minipage}
\end{figure} 
\end{lstlisting}

The positional parameter (here \verb|[t]|) and the width of the two minipages can be adjusted as needed. To finetune the relative vertical positions, one can add \verb|\vspace{}| before \verb|\caption| or \verb|\includegraphics[]{}|.
